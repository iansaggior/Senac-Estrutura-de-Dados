    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            try {
                    ...
                    case 0: // Opções disponíveis na Lista de Contatos
                        ...
                        switch (opcaoContato) {
                            ...
                            case 1: // opção para pesquisar um Contato
                                ...
                                if (idPesquisarContatoString != null && !idPesquisarContatoString.isEmpty()) { // verificar se a variável não foi preenchida corretamente
                                        ...
                                        if (objArray != null) {
                                            ...
                                            JOptionPane.showMessageDialog(null,
                                            "Não foi possível pesquisar o contato com o ID: " + idPesquisarContato + " porque ele não existe!!", "AVISO", JOptionPane.WARNING_MESSAGE);
                                        }
                                } else {
                                    JOptionPane.showMessageDialog(null, 
                                    "Falha ao pesquisar o ID de um contato", "AVISO", JOptionPane.ERROR_MESSAGE);
                                }
                                break;
                            ...
                            case 2: // opção para remover um Contato
                                ...
                                if (idRemoverContatoString != null && !idRemoverContatoString.isEmpty()) {
                                    ...
                                    JOptionPane.showMessageDialog(null, 
                                    "Falha ao remover o contato", "AVISO", JOptionPane.ERROR_MESSAGE);
                                }
                                break;
                            ...
                            case 3: // opção para mostrar a Lista de Contatos
                                System.out.println(
                                        "--------------------------------------------------------------------------------------------------------");
                                listaContato.exibirElemento();
                                break;
    
                            default: // opção inválida
                                JOptionPane.showMessageDialog(null, "...SAINDO DA LISTA CONTATOS...");
                                break;
                        }
                        break;
                    ...
                    case 1: // Opções disponíveis na Lista de Produtos
                        ...
                        switch (opcaoProduto) {
                            ...
                            case 1: // opção para pesquisar produtos na Lista
                                ...
                                if (idPesquisarProdutoString != null && !idPesquisarProdutoString.isEmpty()) { // verificar se a variável não foi preenchida corretamente
                                    ...
                                    JOptionPane.showMessageDialog(null, 
                                    "Falha ao pesquisar o ID do Produto", "AVISO", JOptionPane.ERROR_MESSAGE);
                                }
                                break;
                            ...
                            case 2: // opção para remover produtos na Lista
                                ...
                                if (idRemoverProdutoString != null && !idRemoverProdutoString.isEmpty()) { // verificar se a variável não foi preenchida corretamente
                                    ...
                                    JOptionPane.showMessageDialog(null, "Falha ao remover o produto", "AVISO", JOptionPane.ERROR_MESSAGE);
                                }
                                break;
                            ...
                            case 4: // opção para mostrar os produtos da Lista
                                System.out.println(
                                        "--------------------------------------------------------------------------------------------------------");
                                listaProduto.exibirElemento();
                                break;
    
                            default: // saindo da lista de Produtos
                                JOptionPane.showMessageDialog(null, "...SAINDO DA LISTA PRODUTOS...");
                                break;
                        }
                ...
                JOptionPane.showMessageDialog(null, 
                "Elemento é do tipo númerico!! Tente novamente!!", "AVISO", JOptionPane.WARNING_MESSAGE);
            } catch (Exception e) {
                JOptionPane.showMessageDialog(null, 
                "ERRO!!", "AVISO", JOptionPane.ERROR_MESSAGE);
            }
        } while (opcao != 2);
    }
}
