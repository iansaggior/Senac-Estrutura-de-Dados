...
public class Main {
    public static void main(String[] args) {
        ...
        // Livro livroEncontrado = Array.buscaBinariaPorTitulo("hamlet"); // mudar o parametro para fazer a busca
        ...
        // int removerId = 0; // mudar o parametro para fazer a remoção
        // Array.remover(removerId); 
